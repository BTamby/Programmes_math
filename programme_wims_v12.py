...
def creer_intro(texte):
	...
	#print("Fin = ",fin_texte)
	return dico_intro
	#print("Il y a ",nb_partie," partie dans l'intro")
	#print(titre_partie)
	#print("Dans la fonction : ",texte)
def begin_html():
...
def creer_program(prog):
	...
	for cle,val in dico_all.items():
		...
		if dico_all[cle]['conclusion'][0] != '':
			allhtml = allhtml +'\t\t<div class="small-12 cell program_colonne_cl"><!-- Conclusion du thème '+cle+'-->\n'+dico_all[cle]['conclusion'][0]+'\n\t\t</div><!-- Fin conclusion du thème '+cle+'-->\n'
		#Fin du thème
