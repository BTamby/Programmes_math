...
for cle,val in dico_all.items():
	...
	for num,valeur in enumerate(dico_all[cle]['contenu']):
		...
		allhtml = allhtml +'<div class="box_content2 small-4 medium-4 large-4 cell program_colonne"><!--Colonne contenu-->\n<h4 class="titre_colonne">Contenus</h4>\n'
		#Test 

		allhtml = allhtml +valeur
	...
	i += 1
print("Test : ",dico_all['Vocabulaire ensembliste et logique'])
